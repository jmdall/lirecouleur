	...
	this.autom = {
	 ...
	 // + tous les *nc sauf "onc" et "donc"
		...
		'l' : [['vill','mill','tranquille','illdeb','ill','eil','ll','excep_il', 'apostrophe','lisole'],
				...
				'excep_il':[{'-':/fusi|outi|genti|sourci|persi/i,'+':/(s?)$/i},'#',1], // les exceptions trouvées ou le 'l' à la fin ne se prononce pas : fusil, gentil, outil
		...
		'o' : [['in','oignon','i','ouat','oui','oue','tomn','monsieur','n','m','nm','y1','y2','u','o','oe_0','oe_1','oe_2', 'oe_3','voeux','oeufs','noeud','oeu_defaut','oe_defaut'],
				{'in':[{'+':/i[nm]([bcçdfghjklpqrstvwxz]|$)/i},'w_e~',3],
...
LireCouleurEngine.prototype.regle_ient = function(mot, pos_mot) {
	...
	if (verbes_ier.indexOf(pseudo_infinitif) >= 0) {
		return true;
	}	
